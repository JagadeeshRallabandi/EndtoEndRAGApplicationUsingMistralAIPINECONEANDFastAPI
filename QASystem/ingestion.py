...
def ingest(document_store):
	...
	indexing.run({"converter": {"sources": [Path("D:\Gen_AI_Sunny_Savith\EndtoEndRAGApplicationUsingMistralAIPINECONEANDFastAPI\data\Retrieval-Augmented-Generation-for-NLP.pdf")]}})
